...
function Navbar() {
  return (
    <nav className="bg-gradient-to-t from-blue-100 to-blue-200 py-3 shadow-xs sticky top-0 z-50">
      <Container className="flex items-center justify-between">
        <div className="flex items-center gap-x-3">
          ...
          <div className="relative ">
            <input
              placeholder="search"
              className="flex-1 p-2 pl-10 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-800"
              type="text"
            />
            <Search className="absolute left-3 top-2.5 text-gray-500" />
          </div>
        </div>
        <div className="flex items-center gap-x-10 *:text-gray-600">
          <Image
